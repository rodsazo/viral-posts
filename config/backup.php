...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                // El código vive en git: no respaldamos la app entera, solo los archivos
                // subidos (logos en disco local de dev). En producción los logos están en S3
                // y su durabilidad la da el bucket; aquí lo crítico es el dump de la BD.
                'include' => [
        ...
        'destination' => [
            ...
            /*
             * Disco destino de los backups. En producción es `backups`: un bucket S3
             * SEPARADO del principal (off-site real). En local cae a `local` si no se
             * define BACKUP_DISK, para poder probar `backup:run` sin S3.
             */
            'disks' => [
     ...
     */
    'notifications' => [
        // Solo avisamos cuando algo va MAL (un correo diario de "todo bien" se ignora y
        // acaba ocultando los fallos reales). Éxito/healthy quedan silenciados a propósito.
        'notifications' => [
